...
import { Select, SubmitBtn, LabelAsButton, InvisibleCheckbox } from "../StyledComponents/Forms";
import { 
    PianoSymbol,  
    ViolinSymbol, 
    BassSymbol,
...
const ChoiceBox = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <Flex 
                variant={context.theme} width="100%" flexWrap="wrap" flexDirection="row" alignItems="flex-start" justifyContent="center">
                ...
                <Box m={3} justifyContent="center" flexDirection="column">
                ...
                <Flex flexWrap="wrap" justifyContent="center">
                    ...
                    <Box m={3}>
                        <h3>Velg dur/moll</h3>  
                                ...
                                <input type="radio" value="major" name="minMaj" ref={register} id="major" />
                                <LabelAsButton htmlFor="minor">Moll</LabelAsButton>
                                <input type="radio" value="minor" name="minMaj" ref={register} id="minor" />
                    ...
                    <Box m={3}>
                        ...
                        <input type="radio" value={1} name="levels" ref={register}id="level1" />
                       
                        <LabelAsButton htmlFor="level2">Nivå 2</LabelAsButton>
                        <input type="radio" value={2} name="levels" ref={register} id="level2" />
                       
                        <LabelAsButton htmlFor="level3">Nivå 3</LabelAsButton>
                        <input type="radio" value={3} name="levels" ref={register} id="level3" />
                       
                        <LabelAsButton htmlFor="level4">Nivå 4</LabelAsButton>
                        <input type="radio" value={4} name="levels" ref={register} id="level4" />
                       
                        <LabelAsButton htmlFor="level5">Nivå 5</LabelAsButton>
                        <input type="radio" value={5} name="levels" ref={register} id="level5" />
                       
                        <LabelAsButton htmlFor="level6">Nivå 6</LabelAsButton>
                        <input type="radio" value={6} name="levels" ref={register} id="level6" />
